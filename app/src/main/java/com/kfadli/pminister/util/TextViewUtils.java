...
public class TextViewUtils {
  ...
  public static class PicassoImageGetter implements Html.ImageGetter {
     ...
     *
     * @param view {@link android.widget.TextView} that holds HTML which contains <img> tag to load
     */
  ...
  private static class LoadFromUriAsyncTask extends AsyncTask<Uri, Void, Bitmap> {
    ...
    @Override protected void onPostExecute(Bitmap result) {
      ...
      int height = Math.round(1.0f * width * mUrlDrawable.mDrawable.getIntrinsicHeight()
